...
namespace Inputs
{
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_BuildMenu_Newaction = m_BuildMenu.GetAction("New action");
        }
        ...
        public struct BuildMenuActions
        {
            ...
            public void SetCallbacks(IBuildMenuActions instance)
            {
                ...
                {
                    Newaction.started -= m_Wrapper.m_BuildMenuActionsCallbackInterface.OnNewaction;
                    Newaction.performed -= m_Wrapper.m_BuildMenuActionsCallbackInterface.OnNewaction;
                    Newaction.canceled -= m_Wrapper.m_BuildMenuActionsCallbackInterface.OnNewaction;
                }
